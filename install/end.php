...
?>
                ...
                <form id="save_config" class="form" method="post">
                  ...
                  <div class="form-row">
                    <div class="form-item">
                      <div class="form-input">
                        <textarea style="height: 110px;" type="text" class="form-control" placeholder="1 tiểu sử thì xuống hàng 1 dòng, tối đa 3 tiểu sử" name="tieusu_config" required>Hi my name is ThanhDieu 😍
